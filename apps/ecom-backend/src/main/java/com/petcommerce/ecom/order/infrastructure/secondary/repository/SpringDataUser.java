package com.petcommerce.ecom.order.infrastructure.secondary.repository;
...
import com.petcommerce.ecom.order.infrastructure.secondary.entity.UserEntity;
import org.springframework.stereotype.Repository;

import java.util.Optional;

@Repository
public class SpringDataUser implements UserRepository {

  private final JpaUserRepository jpaUserRepository;

  public SpringDataUser(JpaUserRepository jpaUserRepository) {
